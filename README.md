...
- [API Documentation](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/scalaprops/sbt-scalaprops_2.12_1.0/0.4.0/sbt-scalaprops-0.4.0-javadoc.jar/!/scalaprops/index.html)
